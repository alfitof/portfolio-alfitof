export const greetings = {
  ...
  description: 'I am passionate as a Full Stack web developer having web application experience with PHP, Codeigniter, React.js, Next.js and CSS Framework with Tailwind and bootstrap.',
  resumeLink: 'https://cv.aksel.co.id/r/7zgmwy',
};

export const openSource = {
  githubUserName: 'alfitof',
};

export const contact = {};

export const socialLinks = {
  linkedin: 'https://www.linkedin.com/in/alfito-febriansyah/',
  github: 'https://github.com/alfitof',
  instagram: 'https://www.instagram.com/needsomesauce',
  facebook: 'https://www.facebook.com/alfito.febriansyah',
  twitter: 'https://twitter.com/atlantisbanjir',
};
  ...
  data: [
    {
      ...
      skills: ['Building Responsive E-Commerce in Codeigniter', 'Building responsive portfolio websites using Next.js'],
      softwareSkills: [
        {
          skillName: 'HTML-5',
...
export const educationInfo = [
  {
    schoolName: 'SMAN 1 Ciamis',
    subHeader: 'Science',
    duration: '2017 - 2020',
    grade: '85.71',
    descBullets: ['Join the OPTIK organization (Information Technology Student Organization)'],
  },
  {
